    ...
    public function run(): void
    {
        ...
        foreach ($userIds as $userId)
        {
            DB::table('patients')->insert([
                ...
                'med_morn' => fake()->optional(.9)->randomElement(['', 'Zyrtec', 'Tylenol']),
                'med_noon' => fake()->optional(.9)->randomElement(['', 'Zyrtec', 'Tylenol']),
                'med_night' => fake()->optional(.9)->randomElement(['', 'Zyrtec', 'Tylenol']),
